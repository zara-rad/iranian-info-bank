    ...
    if (query.length > 0) {
      ...
      categoryMatches = categories
        .filter(category =>
          ...
          category.namePersian.includes(query) // 🔹 NEW: Farsi support
        )
        .map(category => ({
          type: 'category',
          name: category.name,
          nameGerman: category.nameGerman,
          namePersian: category.namePersian, // 🔹 NEW
      ...
      categories.forEach(category => {
        const matchingSubcategories = category.subcategories.filter(sub =>
          ...
          sub.namePersian.includes(query) // 🔹 NEW
        )
        ...
        matchingSubcategories.forEach(sub => {
          subcategoryMatches.push({
            ...
            namePersian: sub.namePersian, // 🔹 NEW
