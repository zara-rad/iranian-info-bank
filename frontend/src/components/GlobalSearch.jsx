...
//                 }`}
//               >
//                 {suggestion.type === 'city' && <MapPin size={16} className="text-persian-500 flex-shrink-0" />}
//                 {suggestion.type === 'category' && <Tag size={16} className="text-gold-500 flex-shrink-0" />}
...
//                   {suggestion.type === 'subcategory' ? t("globalSearch.serviceLabel") : suggestion.type}
//                 </span>
//               </button>
//             ))}
//           </div>
...
//               }`}
//             >
//               {suggestion.type === 'city' && <MapPin size={20} className="text-persian-500 flex-shrink-0" />}
//               {suggestion.type === 'category' && <Tag size={20} className="text-gold-500 flex-shrink-0" />}
//               {suggestion.type === 'subcategory' && (
//                 <div className="flex items-center space-x-1 flex-shrink-0">
